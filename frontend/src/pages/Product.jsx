...
const Product = () => {
  ...
  const { products, currency, addToCart, toggleLike, isLiked } =
  ...
  return productData ? (
    <div className="border-t-2 pt-20 px-5 transition-opacity ease-in duration-500 opacity-100">
        ...
        <div className="flex-1">
          ...
          <div className="flex gap-4">
            ...
            <button
              ...
              className="border px-6 py-3 text-sm rounded-md hover:bg-gray-100"
            >
